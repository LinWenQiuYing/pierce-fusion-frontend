<template>
  <div class="create-source">
    <div class="create-source-header">
      <div class="header-text">构图数据源</div>
    ...
    <DataList
      :isLoading="loading"
      className="create-source-content"
      :dataList="dataList"
      checkType="source"
      @handleAdd="handleAdd"
    ...
    <a-pagination
      ...
      class="create-source-pagination"
...
import { typeOptions } from "./components/dataSource";
